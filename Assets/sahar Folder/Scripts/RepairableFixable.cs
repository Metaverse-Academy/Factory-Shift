...
public class RepairableFixable : MonoBehaviour
{
    ...
    [Tooltip("Root RectTransform of the skillcheck UI (same object as skillGroup).")]
    [SerializeField] private RectTransform skillRootRT;
       ...
       private void StartSkillCheck()
    {
        ...
        if (randomizeSkillCheckPosition && skillRootRT != null)
        {
            ...
            float ry = UnityEngine.Random.Range(randomOffsetMin.y, randomOffsetMax.y);
            skillRootRT.anchoredPosition = skillRootRestPos + new Vector2(rx, ry);
        }
        else if (skillRootRT != null)
        {
            // keep centered
